...
public class UserResourceRESTServiceTest {
    ...
    public void listAllTest() throws Exception {
        ...
        assertEquals("Wrong user name", "Carl", users.get(0).getName());
        assertEquals("Wrong user forname", "Hostings", users.get(0).getForname());
        assertEquals("Wrong user name", "Peter", users.get(1).getName());
        assertEquals("Wrong user forname", "Nash", users.get(1).getForname());        
    ...
    public void lookupByIdTest() throws Exception {
        Client client = ClientBuilder.newBuilder().build();
        WebTarget target = client.target("http://localhost:8080/test/rest/user/0");
        Response response = target.request(MediaType.APPLICATION_JSON).get();
        assertEquals(200, response.getStatus());
    ...
    public void createTest() throws Exception {
        ...
        assertEquals("Wrong user id.", 3, users.get(0).getId().intValue());
