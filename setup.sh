...
${WILDFLY_LOCATION}/bin/jboss-cli.sh --connect --controller=localhost:9990 --command="profile=full/subsystem=datasources/jdbc-driver=mysql:add(driver-name=mysql,driver-module-name=com.mysql,driver-class-name=com.mysql.jdbc.Driver)"
